package com.guidly.backend.config;

import com.guidly.backend.security.JwtAuthFilter;
...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // permet d'utiliser @PreAuthorize sur les controllers (defense en profondeur)
